...
public class Bip39 {
    private static HashSet<String> BIP39_ENGLISH_WORDS_SET = new HashSet<>() ;
    ...
    static {
        String [] words = new String[]{
                ...
                "zone",
                "zoo"};
        Arrays.stream(words).forEach(word-> BIP39_ENGLISH_WORDS_SET.add(word));
    }
...
//            return String.join(" ", words);
    ...
    public static boolean isValidMnemonicCode(String mnemonicCode){
        ...
        try{
            ...
            return words.size() == 12 && words.stream().allMatch(word->BIP39_ENGLISH_WORDS_SET.contains(word));
        }
        catch (Exception ex){
            return false;
        }
